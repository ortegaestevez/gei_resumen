...
FM &= A_{C} - P_{C}  \\
&= t + a + c + v + e - p  \\
&= t + \frac{A}{365} \cdot PM_{a} + \frac{C}{365} \cdot PM_{c} + \frac{V}{365} \cdot PM_{v} + \frac{E}{365} \cdot PM_{e} - \frac{P}{365} \cdot PM_{p}
\end{align*}
...
\begin{align*}
X \cdot p - X \cdot c_{v} - C_{F} = 0 \\
\rightarrow X = \frac{C_{F}}{p - c_{v}}
\end{align*}
...
- Referentes al activo. Para estudiar la estructura económica de la empresa:
    ...
    1. Ratio del activo fijo. - $A_{F} / A$
    1. Ratio de tesorería. - $T / A$
    1. Realizable. - $R / A$
    1. Existencias. - $E / A$

- Referentes al pasivo. Para estudiar su estructura financiera:
    1. Pasivo a corto plazo. - $P_{C} / P$
    1. Recursos propios. - $K / P$
    1. Recursos ajenos. - RA / P
    1. Capitales permanentes. - $C_{P} / P$
