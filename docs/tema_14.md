...
1. **Introducción o lanzamiento.** Cuando el producto es nuevo en el mercado tiene la ventaja de que existen pocos competidores, y el inconveniente de que la mayoría de los consumidores no han probado el producto y, en consecuencia, saben poco de él, por lo que el crecimiento de las ventas es lento.
...
2. **Crecimiento.** A medida que el producto va siendo más conocido, si satisface al mercado, las ventas comienzan a crecer sustancialmente, lo que atrae a la competencia. La empresa comienza a diferencia el producto para introducirse en nuevos segmentos, lo que requerirá una diferenciación en las políticas de marketing-mix.
...
4. **Declive.** Las ventas comienzan a descender, con mayor o menor celeridad, debido a los cambiantes deseos de los consumidores, a la introducción de nuevos productos sustitutivos, o ambas razones.
...
*Figura 14.2 Ciclo de vida de un producto*
...
6. **Comercialización.** Si los resultados de las pruebas son favorables, el producto es comercializado y comienza la fase de introducción de su ciclo de vida.
...
*Figura 14.3 Curva de demanda*

***Bienes Giffen.*** El volumen de compras se reduce al disminuir el precio:

1. Suelen ser artículos que satisfacen necesidades primarias.
1. Los consumidores pueden no ser muy aficionados a ellos, pero, dado su nivel de renta, se ven obligados a su consumo.
1. Cuando su precio desciende, el consumidor descubre que su renta real ha aumentado y los adquiere en menor cuantía, comprando otros bienes con el remanente de su renta.

La estimación de la curva de demanda puede basarse en:

1. La subjetividad del empresario.
1. Datos históricos.
1. Datos conseguidos mediante sondeos realizados a consumidores.
1. Experimentación analizando la respuesta de los consumidores para diferentes niveles de precios en diversos establecimientos o mercados.
...
- **Elástica**. Cuando la elasticidad es superior a la unidad. Reduciendo el precio se produciría un incremento en la cantidad demandada en proporción superior al descenso del precio, por lo que los ingresos se incrementarían.
- **Inelástica**. Cuando la elasticidad es inferior a uno. Una reducción del precio originaría un aumento de la demanda de menor proporción, con lo que los ingresos se reducirían. Convendría aumentar el precio.
- **Normal**. Cuando la elasticidad es igual a uno. Las modificaciones de precios producen variaciones proporcionalmente iguales en la demanda. Es la elasticidad para la cual el ingreso es máximo.
...
1. El beneficio o la rentabilidad. La rentabilidad es un objetivo preferible al beneficio.
1. Las ventas o la cuota de mercado.
    1. Para maximizar las ventas se fija un mínimo aceptable de beneficio y se trata de maximizar el volumen de ventas.
    1. Con el aumento de la cuota de mercado se trata de desplazar a la competencia, incrementando la participación de la empresa en el mercado.
1. El mantenimiento de cierta situación en relación a la competencia.
1. Consideraciones éticas y sociales.
1. Cuestiones vinculadas a la imagen de la empresa y de sus productos.
...
1. **Precios promocionales.** Pueden utilizarse para introducir un producto nuevo al mercado, revitalizar un producto antiguo o introducirlo en un nuevo segmento.
1. **Líneas de precios.** Se fija un cierto número limitado de precios con objeto de simplificar la decisión del consumidor y crear una imagen concreta fácilmente perceptible.
1. **Precios psicológicos.** Los precios se fijan atendiendo a la reacción psicológica del consumidor.
1. **Precios flexibles.** Varían de mercado a mercado e incluso de consumidor a consumidor. Es una estrategia frecuente en mercados industriales grandes, en los que los clientes que cuentan con cierta antigüedad, o cuyos volúmenes de compras son elevados, reciben de los fabricantes e intermediarios mejores precios que los demás.
1. **Descuentos.** Se aplican sobre los precios reseñados en catálogos (**precios de lista**). Pueden ser

    1. Por pronto pago
    1. Por volumen de compras
    1. De temporada
    1. Funcionales. Son los que se aplica a intermediarios que realizan algunas funciones como la clasificación de los productos, su envasado, etc.

1. **Referencia geográfica de precios.** El precio final percibido por el proveedor y el abonado por el cliente resultan afectados por las cláusulas de referencia geográfica de los precios. En la cláusula FOB (*Free On Board*) el vendedor dejará la mercancía a bordo del medio de transporte, siendo de cuenta del comprador el gasto de transporte desde ese momento, así como el riesgo de que la mercancía resulte dañada con posterioridad.
...
***Publicidad.*** Forma de comunicación en masa que tiene como objetivos

- Transmitir información
- Crear una actitud
- Inducir a una acción beneficiosa para quien la realiza

Se distingue:

- **Publicidad difusa.** Pretende dar a conocer algo.
...
1. Gastar el importe que resta del beneficio una vez atendida la rentabilidad normal del capital.
1. Gastar un porcentaje fijo de las ventas en unidades monetarias.
1. Asignar un presupuesto variable en función de los gastos que realice la competencia, no gastando menos que la media, ni mucho más, lo que podría dar lugar a una guerra publicitaria.
1. Presupuestar tras analizar los objetivos y los costes para alcanzarlos.

Respecto a cada procedimiento:

- Los dos primeros conducen a la realización de mayores esfuerzos publicitarios cuando menos necesarios son (ventas y beneficios elevados). En lugar de amortiguar las oscilaciones económicas coyunturales, las acentúan.
- El tercero no siempre se justifica porque a veces pueden requerirse esfuerzos publicitarios muy superiores a la media del sector.
- El mejor es el último. Se trata de determinar el volumen de gastos que optimiza el objetivo. El problema es que generalmente no se conoce la relación funcional existente entre las ventas y el esfuerzo publicitario y sin cierto grado de conocimiento de la relación no es posible llegar a una optimización de la decisión ni de forma aproximada.
...
Generalmente se considera que la curva correspondiente a la función adopta una forma semejante a la siguiente figura: inicialmente las ventas se incrementan más que proporcionalmente con los aumentos de los presupuestos de publicidad, hasta cierto nivel a partir del cual lo hacen menos que proporcionalmente. Existe un nivel de ventas mínimo que no requiere publicidad y otro máximo que se alcanza a medida que el mercado se va saturando.

![](./assets/images/image39.png)

*Figura 14.4 Relación entre las ventas y el presupuesto publicitario*
...
***Audiencia de un soporte.*** Número de personas de la población-objetivo a las que les llega el mensaje. Es una de las magnitudes de mayor importancia en la selección de medios y soportes.
...
2. Difusión del medio y el soporte entre el segmento de población al que se desea dirigir la comunicación.
3. Características del producto.
4. Características de la población-objetivo.
5. Posibilidades de anunciar el producto en momentos concretos del tiempo, como los cercanos a la decisión de compra.
...
\begin{align*}
P &= \frac{n}{N} = \frac{n_{1} + n_{2} + n_{3} - n_{12} - n_{13} - n_{23} + n_{123}}{N} \\
&= P_{1} + P_{2} + P_{3} - P_{12} - P_{13} - P_{23} + P_{123}
\end{align*}
...
- **Modelos econométricos.** Separan los efectos de la publicidad de los demás factores y se incorporan los efectos temporales.
...
***Merchandising.*** Conjunto de decisiones y actividades relativas a la exposición de los productos en el lugar de venta, el espacio dedicado a cada uno de ellos, su presentación y, en general, la disposición de los artículos en la tienda o almacén de venta. Los principales servicios en los que se basa son:
...
***Venta personal.*** Venta realizada mediante contacto personal entre el vendedor, agente o representante de la empresa y el comprador. Es una forma de distribución pero también un instrumento de promoción de gran importancia.
...
1. Cada vendedor percibe periódicamente un montante igual a cierta proporción de una cantidad que puede ser:

    - Su volumen de ventas en el periodo
    - El importe en el que estas excedan cierta cuantía
    - El margen bruto correspondiente a aquél o a éste

1. La proporción del sistema de comisiones puede ser idéntica para todos los productos o diferente.
1. Es un sistema que estimula las ventas a coto plazo, aunque a largo plazo puede tener efectos negativos pues el personal de venta puede descuidar otras funciones que le son propias.
1. Tiene la ventaja de la sencillez tanto en el cálculo de la retribución de los vendedores como en la determinación del presupuesto.
1. La irregularidad de los salarios de los vendedores en cada periodo y la falta de atención a otros aspectos pueden provocar conflictos y redundar en una falta de identificación del vendedor con la firma.
...
- $I_{j}$ - momento de inercia del territorio $j$.
- $V_{i}$ - montante de ventas al cliente $i$.
- $N_{j}$ - número de clientes del territorio $j$.
- $D_{\text{ih}}$ - distancia del cliente $i$ al origen o base de venta $h$.
...
1. La venta no se encuentra realmente completa hasta que el producto es adquirido por el consumidor final, al que hay que hacérselo llegar.
1. Los distribuidores continúan las actividades de marketing de la empresa, siendo responsables, en muchas ocasiones, del servicio al cliente y de actividades posteriores a la venta que pueden afectar a la imagen del producto y a la empresa fabricante.
1. La mayor parte de los distribuidores trabajan con productos y marcas que compiten entre sí, y el apoyo de los distribuidores en unos u otros puede ser un factor de gran incidencia en sus respectivos volúmenes de ventas.
1. La mayor parte de los productos se suelen encontrar en la fase de madurez de su ciclo de vida y es en esta etapa en la que el apoyo de los distribuidores tiene mayor importancia.
...
1. **Reducción del número de intercambios.** En general, si hay $F$ fabricantes y $D$ detallistas, el número de transacciones será $F \cdot D$. Al incluir un mayorista, el número de intercambios se reduce a $F + D$.
1. **Economicidad.** Al reducirse el número de intercambios, se economiza tiempo y costes de transporte y desplazamientos. Sin embargo, cada intermediario tiene también unos costes y precisa un margen de beneficios para su supervivencia. La optimización del canal es un problema de cálculo económico en el que hay que tener en cuenta ambas cuestiones.
1. **Creación de utilidad.** Disponiendo los bienes en el lugar, momento y cantidad que el consumidor precisa.
1. **Normalización del producto.** Muchos distribuidores compran productos con características heterogéneas y los agrupan por clases o calidades, a los que asignan precios diferentes, normalizando con ello el producto y facilitando la decisión de compra.
1. **Especialización de la función de distribución.** Su especialización permite una reducción de costes.
1. **Comunicación y promoción.** Los intermediarios proporcionan información al fabricante y promocionan sus productos. En general, la información será tanto mejor cuanto más corto sea el canal.
1. **Financiación.** Cuando paga al contado, el distribuidor financia al fabricante o al intermediario anterior, el cual no precisa que el producto llegue al consumidor final para recuperar sus costes y obtener un margen. Los intermediaros, en ocasiones, financian al siguiente distribuidor y al consumidor, en el caso de los detallistas, permitiéndole el pago aplazado de sus compras.
...
3. Un criterio más amplio, que aparte de una relación de las funciones que se desea que desarrolle el canal, las jerarquiza por orden de importancia, evalúa la capacidad de desempeño de tales funciones por los canales existentes y los que se pudieran crear, y selecciona en base al grado de adecuación entre objetivos deseados y medios disponibles.

Existen, además, ciertas limitaciones que condicionan la selección:

1. Las características de los consumidores, del mercado y del producto.
1. Las posibles limitaciones legales.
1. Las disponibilidades financieras que pueden impedir la creación de una red propia y obligar a la utilización de los canales exteriores.
1. Las características de los canales existentes y su grado de adecuación a los objetivos de la empresa.

La innovación en materia de distribución puede consistir en:

1. La utilización de nuevos canales.
1. La reorganización del canal habitual.
1. La nueva utilización de canales ya existentes.
...
1. **Poder de compensación económica**. Se basa en la oferta de beneficios o recompensas económicas.
1. **Poder de reconocimiento**. Se deriva de una capacidad de liderazgo y de un prestigio asumido por otros miembros del canal.
1. **Poder de experiencia**. Se basa en la disponibilidad de experiencia y de conocimientos que otros miembros no tienen.
1. **Poder legítimo**. Es el que se basa en las normas existentes, así como en los acuerdos y contratos establecidos entre los miembros del canal.
