...
1. **Según su duración.** Depende de la actividad de la empresa:
    1. **Capitales permanentes**, $\text{CP}$.
...
2. **Según su titularidad.**
    1. **Recursos financieros propios, $K$**. Aquellos que no han de devolverse nunca.
        ...
        1. autofinanciación
    2. **Recursos financieros ajenos**, $D$. Su devolución le será exigida a la empresa en un período de tiempo más o menos amplio. Provienen de las distintas formas de endeudamiento.
3.  **Según su procedencia.**
    1. **Externos**, $E$. Conseguidos en el exterior de la empresa captando el ahorro de otros.
        1. Aportaciones de los socios
        1. Emisión de obligaciones
        1. Todas las demás formas de endeudamiento
    2. **Internos**, $I$. Generados dentro de la empresa mediante su propio ahorro. La fuente de recursos internos es la autofinanciación.
...
1. La rentabilidad requerida de las inversiones no puede ser nunca inferior que su coste de financiación; hay que conocer el coste del capital para decidir entre inversiones.
1. Cuando la rentabilidad operativa de la empresa es mayor que el coste de sus deudas, el endeudamiento eleva la rentabilidad financiera y con ello el valor de las acciones. Para tomar decisiones referentes al endeudamiento de la empresa es preciso prever su rentabilidad económica y conocer el coste de sus deudas.
1. Selección de fuentes de financiación; siendo preferibles las menos costosas.
...
1. No existen gastos de intermediación ni impuestos
1. Los intereses se pagan anualmente y todos los años
1. La emisión y el reembolso del crédito se efectúan por su nominal
1. El coste coincide con el tipo de interés
...
\begin{align*}
A - k_{i} \cdot A \cdot \frac{\left( 1 + k_{i} \right)^{n} - 1\ }{\left( 1 + k_{i} \right)^{n} \cdot k_{i}} - \frac{A}{\left( 1 + k_{i} \right)^{n}}
&= A - A \cdot \frac{\left( 1 + k_{i} \right)^{n} - 1\ }{\left( 1 + k_{i} \right)^{n}} - \frac{A}{\left( 1 + k_{i} \right)^{n}} \\
&= A \cdot \left\lbrack 1 - \frac{\left( 1 + k_{i} \right)^{n} - 1\ }{\left( 1 + k_{i} \right)^{n}} - \frac{1}{\left( 1 + k_{i} \right)^{n}} \right\rbrack
\end{align*}
...
\begin{align*}
0 &= A - \frac{Q}{1 + k_{i}} - \frac{Q}{\left( 1 + k_{i} \right)^{2}} - \ldots - \frac{Q}{\left( 1 + k_{i} \right)^{n}} \\
&= A - Q\left\lbrack \frac{1}{1 + k_{i}} + \frac{1}{\left( 1 + k_{i} \right)^{2}} + \ldots + \frac{1}{\left( 1 + k_{i} \right)^{n}} \right\rbrack \\
&= A - Q \cdot a_{\left. \ n \right\rceil k_{i}}
\end{align*}
...
&= \sum^{\infty}_{n=1}{\frac{d_{n}}{(1+k_{e})^{n}}}
\end{align*}
...
1. Si la renta del país crece, la de la empresa media también lo hará.
1. Cuando existe inflación y los dividendos son constantes, su valor real se va reduciendo con el tiempo.
...
1. Se consigue uno de los objetivos de la empresa: crecimiento del beneficio, y por tanto también crecerán los dividendos.
...
1. Las acciones no incorporan un compromiso de pago de dividendos porque estos se reparten total o parcialmente cuando la empresa obtiene beneficios.
1. Si la empresa quiebra, las deudas se pagan con la liquidación de los activos. Después de pagar a los acreedores, el dinero restante; si lo hay, se reparte entre los accionistas.
1. Los precios de las acciones oscilan mucho más que los de las obligaciones, por lo cual su riesgo es mucho más elevado.
...
\begin{alignat*}{2}
R^{'} 
&\geq R &&\rightarrow \frac{d + r \cdot m}{k_{e}} \\
&\geq \frac{d}{k_{e}} + m &&\rightarrow \frac{d}{k_{e}} + \frac{r \cdot m}{k_{e}} \\
&\geq \frac{d}{k_{e}} + m \\
\end{alignat*}
...
5. Pago de dividendos variables en función de las necesidades financieras de la empresa dadas las inversiones disponibles.
...
1. $S$ - recursos propios
1. $k_{e}$ - coste anual
1. $B$ - recursos ajenos 
1. $k_{i}^{'}$ - coste anual neto de impuestos
